...
venue: "R-Ladies Chicago"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
address: "Remote"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
enddate: 19:00        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
